...
?>
	...
	?>
		<div class="btn-group">
			<button id="filter-sasi" type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="fa fa-cogs" aria-hidden="true"></i>Filter<span class="caret"></span></button>
