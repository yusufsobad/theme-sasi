								...
								<div class="icon-user-content pt-md">
									<div class="row">
										...
										<div class="col-xs-4 col-sm-5 pt-sm pl-sm pr-0">
											<img class="radius-circle" src="<?php print($image); ?>" style="width: 40px; height:40px">
										</div>
									</div>
								</div>
